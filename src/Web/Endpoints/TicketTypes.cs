    ...
    public static void Map(RouteGroupBuilder group)
    {
        group.MapGet(GetTicketTypes, string.Empty)
            ...
            .WithDescription(OpenApiDescriptionBuilder.Build(
                ...
                "Sightseeing: INFANT mien phi co dinh; CHILD/SENIOR/DISABLED dung chung % giam tai /api/ticket-types/sightseeing-concession.",
        ...
        group.MapGet(GetTicketFareRules, "fare-rules")
            ...
            .WithDescription(OpenApiDescriptionBuilder.Build(
                ...
                "INFANT la mien phi co dinh ca Regular lan SightseeingLoop."));
