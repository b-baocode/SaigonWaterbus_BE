    ...
    public static void Map(RouteGroupBuilder group)
    {
        group.MapPost(Ask, "ask")
            ...
            .WithDescription(OpenApiDescriptionBuilder.Build(
                ...
                "PHAM VI: huong dan vien chi tra cuu dia danh, tuyen - lo trinh, ga/ben, quy dinh va "
                + "lich trinh cua DUNG chuyen dang di (qua tripId). Chuyen khac/ngay khac, gia ve, "
                + "cho trong, khuyen mai, thue tau: dung chatbox text (/api/assistant/chat), o day "
                + "co tinh KHONG mo cac tool do.",
