...
public sealed class ResendOtpRequestUseCase
{
    ...
    public async Task<OtpChallengeDto> ExecuteAsync(ResendOtpRequest request, CancellationToken cancellationToken)
    {
