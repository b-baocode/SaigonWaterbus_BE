...
public sealed record SendGooglePhoneOtpRequest(string TempToken, string Phone);

public sealed class SendGooglePhoneOtpRequestValidator : AbstractValidator<SendGooglePhoneOtpRequest>
{
    public SendGooglePhoneOtpRequestValidator()
    {
...
public sealed class SendGooglePhoneOtpRequestUseCase
{
    ...
    public SendGooglePhoneOtpRequestUseCase(
    ...
    public async Task<GooglePhoneOtpSentDto> ExecuteAsync(SendGooglePhoneOtpRequest request, CancellationToken cancellationToken)
    {
