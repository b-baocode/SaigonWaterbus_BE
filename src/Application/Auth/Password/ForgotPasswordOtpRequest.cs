...
public sealed record ForgotPasswordOtpRequest(string? EmailOrPhone = null);

public sealed class ForgotPasswordOtpRequestValidator : AbstractValidator<ForgotPasswordOtpRequest>
{
    public ForgotPasswordOtpRequestValidator()
    {
...
public sealed class ForgotPasswordOtpRequestUseCase
{
    ...
    public async Task<OtpChallengeDto> ExecuteAsync(ForgotPasswordOtpRequest request, CancellationToken cancellationToken)
    {
