...
public sealed class PayOsCharterBookingPaymentGateway : ICharterBookingPaymentGateway
{
    private const string HttpClientName = "PayOS";
    private readonly IHttpClientFactory _httpClientFactory;
    private readonly IOptionsMonitor<PayOsOptions> _optionsMonitor;
    private readonly ILogger<PayOsCharterBookingPaymentGateway> _logger;

    public PayOsCharterBookingPaymentGateway(
        IHttpClientFactory httpClientFactory,
        IOptionsMonitor<PayOsOptions> optionsMonitor,
        ILogger<PayOsCharterBookingPaymentGateway> logger)
    {
    ...
    public async Task<CharterBookingDepositPaymentResult> CreateDepositPaymentAsync(
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            return new CharterBookingDepositPaymentResult(
    ...
    public async Task<CharterBookingPaymentCancellationResult> CancelPaymentAsync(
        long orderCode,
        string reason,
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            return new CharterBookingPaymentCancellationResult(
    ...
    public async Task<CharterBookingPaymentStatusResult> GetPaymentAsync(
        long orderCode,
        CancellationToken cancellationToken)
    {
        var options = GetEnabledOptions();
        ...
        try
        {
            ...
            return new CharterBookingPaymentStatusResult(
    ...
    public bool IsValidWebhook(CharterBookingDepositPaymentWebhook webhook)
    {
    ...
    private async Task<CharterBookingRefundPayoutResult> CreateRefundPayoutCoreAsync(
        CharterBookingRefundPayoutRequest request,
        CancellationToken cancellationToken)
    {
    ...
    private async Task<CharterBookingRefundPayoutResult?> TryGetRefundPayoutByReferenceIdAsync(
    ...
    private async Task<CharterBookingRefundPayoutResult?> GetRefundPayoutByReferenceIdCoreAsync(
        PayOsOptions options,
        PayOsCredentials payoutCredentials,
        string referenceId,
        CancellationToken cancellationToken)
    ...
    private static CharterBookingRefundPayoutResult ToRefundPayoutResult(
        PayOsCreatePayoutData data,
        string? description)
    {
        var transaction = data.Transactions?.FirstOrDefault();
        return new CharterBookingRefundPayoutResult(
            data.Id,
            data.ApprovalState
                ?? transaction?.State
                ?? "Created",
    ...
    private static void ValidateRefundPayoutRequest(CharterBookingRefundPayoutRequest request)
    {
