...
namespace SaigonWaterbus.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260625023824_AddCharterBookingHold")]
    partial class AddCharterBookingHold
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SaigonWaterbus.Domain.Entities.CharterBooking", b =>
                {
                    ...
                    b.Property<string>("VesselRequirements")
                        .HasMaxLength(1000)
                        .HasColumnType("character varying(1000)")
                        .HasColumnName("vessel_requirements");

                    b.HasIndex("FromStationId");

                    b.HasIndex("ToStationId");

                    b.HasIndex("VesselId", "DepartureDate")
                        .IsUnique()
