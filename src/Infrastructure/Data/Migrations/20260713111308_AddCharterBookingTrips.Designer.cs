...
namespace SaigonWaterbus.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260713111308_AddCharterBookingTrips")]
    partial class AddCharterBookingTrips
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SaigonWaterbus.Domain.Entities.BoatCrewAssignment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                        .HasColumnName("boat_crew_assignment_id");
                    ...
                    b.HasIndex("StaffUserId", "IsActive");

                    b.HasIndex("BoatId", "CrewRole", "IsActive");

                    b.ToTable("boat_crew_assignments", (string)null);
                });
            ...
            modelBuilder.Entity("SaigonWaterbus.Domain.Entities.BoatCrewAssignment", b =>
                {
                    b.HasOne("SaigonWaterbus.Domain.Entities.User", "AssignedByUser")
                        .WithMany("AssignedBoatCrewAssignments")
                    ...
                    b.HasOne("SaigonWaterbus.Domain.Entities.BoatCrewAssignment", "ReplacesAssignment")
                        .WithMany("ReplacementAssignments")
                        .HasForeignKey("ReplacesAssignmentId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("SaigonWaterbus.Domain.Entities.User", "StaffUser")
                        .WithMany("BoatCrewAssignments")
            ...
            modelBuilder.Entity("SaigonWaterbus.Domain.Entities.BoatCrewAssignment", b =>
                {
                    b.Navigation("ReplacementAssignments");
                });
            ...
            modelBuilder.Entity("SaigonWaterbus.Domain.Entities.User", b =>
                {
                    b.Navigation("AssignedBoatCrewAssignments");

                    b.Navigation("AssignedStationAssignments");

                    b.Navigation("BoatCrewAssignments");
