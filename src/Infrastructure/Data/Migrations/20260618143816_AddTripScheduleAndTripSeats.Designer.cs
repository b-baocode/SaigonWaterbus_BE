...
namespace SaigonWaterbus.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260618143816_AddTripScheduleAndTripSeats")]
    partial class AddTripScheduleAndTripSeats
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SaigonWaterbus.Domain.Entities.GeneratedTrip", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                        .HasColumnName("generated_trip_id");
                    ...
                    b.Property<Guid>("TripScheduleId")
                        .HasColumnType("uuid")
                        .HasColumnName("trip_schedule_id");
                    ...
                    b.HasIndex("TripScheduleId", "OperatingDate")
                        .IsUnique();

                    b.ToTable("generated_trips", (string)null);
                });
            ...
            modelBuilder.Entity("SaigonWaterbus.Domain.Entities.TripSchedule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("trip_schedules", (string)null);
                });
            ...
            modelBuilder.Entity("SaigonWaterbus.Domain.Entities.GeneratedTrip", b =>
                {
                    b.HasOne("SaigonWaterbus.Domain.Entities.Trip", "Trip")
                        .WithOne("GeneratedTrip")
                        .HasForeignKey("SaigonWaterbus.Domain.Entities.GeneratedTrip", "TripId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SaigonWaterbus.Domain.Entities.TripSchedule", "TripSchedule")
