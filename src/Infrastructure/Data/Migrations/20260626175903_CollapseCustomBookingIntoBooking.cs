...
{
    /// <inheritdoc />
    public partial class CollapseCustomBookingIntoBooking : Migration
    {
        /// <inheritdoc />
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.RenameColumn(
                name: "booking_id",
                table: "itinerary_stops",
                newName: "custom_booking_id");

            migrationBuilder.RenameIndex(
                name: "IX_itinerary_stops_booking_id_stop_order",
                table: "itinerary_stops",
                newName: "IX_itinerary_stops_custom_booking_id_stop_order");

            migrationBuilder.AddForeignKey(
                name: "FK_itinerary_stops_bookings_custom_booking_id",
                table: "itinerary_stops",
                column: "custom_booking_id",
                principalTable: "bookings",
                principalColumn: "booking_id",
                onDelete: ReferentialAction.Cascade);
        }
