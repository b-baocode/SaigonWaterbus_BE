...
public sealed class BookingPassengerConfiguration : IEntityTypeConfiguration<BookingPassenger>
{
    public void Configure(EntityTypeBuilder<BookingPassenger> builder)
    {
        ...
        builder.Property(x => x.ApprovalStatus)
            ...
            .IsRequired();
        builder.Property(x => x.RequestBatchId).HasColumnName("request_batch_id");
        ...
        builder.Property(x => x.CharterSeatId).HasColumnName("charter_seat_id");
        ...
        builder.HasIndex(x => new { x.BookingId, x.CharterSeatId }).IsUnique();
        ...
        builder.HasOne(x => x.CharterSeat).WithMany().HasForeignKey(x => x.CharterSeatId).OnDelete(DeleteBehavior.SetNull);
