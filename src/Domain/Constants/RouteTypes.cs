...
public static class RouteTypes
{
    ...
    public static bool IsValid(string? value) =>
        ...
        || string.Equals(value, Charter, StringComparison.OrdinalIgnoreCase)
    ...
    public static string Normalize(string? value) =>
        value?.Trim() switch
        {
            ...
            var routeType when string.Equals(routeType, Charter, StringComparison.OrdinalIgnoreCase) => Charter,
    ...
    public static bool IsBookableByDefault(string routeType) =>
        !string.Equals(routeType, Charter, StringComparison.Ordinal)
